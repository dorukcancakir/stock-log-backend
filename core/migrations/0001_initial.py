    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='inventory', to='core.company')),
            ],
        ),
        migrations.CreateModel(
            name='Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventory_items', to='core.inventory')),
        ...
        migrations.AddField(
            model_name='item',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='core.itemcategory'),
        ),
        migrations.CreateModel(
            name='ItemTag',
            fields=[
        ...
        migrations.AddField(
            model_name='item',
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='core.itemtag'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['company'], name='core_invent_company_ab9b11_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['company'], name='core_invent_company_015381_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['inventory'], name='core_invent_invento_a491b3_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['item'], name='core_invent_item_id_00747e_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['quantity'], name='core_invent_quantit_5ca244_idx'),
        ),
        migrations.AddIndex(
            model_name='inventoryitem',
            index=models.Index(fields=['min_quantity'], name='core_invent_min_qua_0f481e_idx'),
        ),
